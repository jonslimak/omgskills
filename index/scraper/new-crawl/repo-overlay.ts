...
function normalizeRepoEntry(entry: ShadowRepoIndexEntry): ShadowRepoIndexEntry {
  return {
    ...
    lastCheapCheckedAt: entry.lastCheapCheckedAt ?? null,
    lastObservedRepoUpdatedAt: entry.lastObservedRepoUpdatedAt ?? null,
...
function overlayComparableEntry(entry: ShadowRepoIndexEntry) {
  ...
  return {
    ...
    lastCheapCheckedAt: normalized.lastCheapCheckedAt,
    lastObservedRepoUpdatedAt: normalized.lastObservedRepoUpdatedAt,
